      ...
      <div className="login-form-container w-full max-w-sm sm:max-w-md relative z-10">
        ...
        <div className="w-full mb-6">
          <input
            ...
            autoFocus
            className={`input-premium text-center text-lg ${isValid ? 'valid' : ''}`}
        ...
        {/* Welcome Preview */}
        {isValid && !showWelcome && (
          <p className="text-text-muted text-caption mt-8 text-center animate-fade-in">
            Welcome to PropHit, <span className="text-gold">{name.trim()}</span>
          </p>
        )}
      ...
      {showWelcome && (
        ...
        >
          ...
          <div className="welcome-content" onClick={e => e.stopPropagation()}>
            ...
            {/* Name — The Hero Moment (Glow Reveal) */}
            <h2 className="welcome-name heading-luxury">
              {name.trim()}
            </h2>
